...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SettingsEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            m_PropDefaultTextMeshProUITextCa given Font Asset.");
            public static readonly GUIContent fallbackFontAssetsListLabel = new GUIContent("Fallback Font Assets List", "The Font Assets that will be searched to locate and replace missing characters from a gizedObject.FindProperty("m_fallbackFontAssets"), true, true, true, true);
